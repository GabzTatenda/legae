...
<html>
<head>
    <title>{{config('appname', 'Legae E-learning')}}</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper row0">
        <div id="topbar" class="clear">
            ...
            <nav>
                <ul>
                    <li><a href="/">Home</a></li>
					<li><a href="/admin/">Online Application</a></li>
                    <li><a href="Slogin/login.php">Student Login</a></li>
                    <li><a href="/dash">Admin Login</a></li>
                </ul>
            </nav>
            <!-- ################################################################################################ -->
        </div>
            ...
            <div id="slide-wrapper" class="rounded clear">
                ...
                <figure id="slide-2">
                    ...
                    <figcaption>
						...
						<li> View your Online Transcript and download as a PDF document.</li>
                        <p class="right"><a href="#">Continue Reading &raquo;</a></p>
                    </figcaption>
                </figure>
                <figure id="slide-3">
                    ...
                    <figcaption>
                        <h2>About E-Learning System</h2>
						<li>Discuss with your class-mates.</li>
						<li> Submit your assignments online.</li>
                        <p class="right"><a href="#">Continue Reading &raquo;</a></p>
                    </figcaption>
                </figure>
                <figure id="slide-4">
                    <a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
                    <figcaption>
                        <h2>E-Learning Features</h2>

						<li>Download Learning materials from your lecturers.</li>
						<li>Communicate in an organized manner with your Lecturers.</li>
                        <p class="right"><a href="#">Continue Reading &raquo;</a></p>
                    </figcaption>
                </figure>
                <figure id="slide-5">
                    ...
                    <figcaption>
                        <h2>About E-Learning System</h2>
						<li> View your personalized learning and examination timetable.</li>
						<li>Track your student ID card.</li>
                        <p class="right"><a href="#">Continue Reading &raquo;</a></p>
                    </figcaption>
                </figure>
                <!-- ################################################################################################ -->
