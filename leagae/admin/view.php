...
<div id="body">
 <table width="80%" border="1">
    <tr>
    <th colspan="4">Student Photos<label><a href="CRUD.php">Continue to Update Personal Details</a></label></th>
    </tr>
    <tr>
...
while($row=$sql->fetch_assoc()){
  ?>
        ...
        <td><a href="images/stPhotos/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
        </tr>
        <?php
 }
 ?>
