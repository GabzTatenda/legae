 var current_fs, next_fs, previous_fs; //div
var left, opacity, scale; //div properties which we will animate
 ...
 S(".next").click(function() {
  ...
  //activate next stop on progressbar using the index of next_fs
    S("#progressbar li").eq(S("div").index(next_fs)).addClass("active");
...
S(".previous").click(function() {
    ...
    S("#progressbar li").eq(S("div").index(current_fs)).addClass("active");
